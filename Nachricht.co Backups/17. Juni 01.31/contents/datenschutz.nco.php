...
<div id="content">
	...
	<h3>§1 Der Service</h3>
	<p>Nachricht.co ist ein Internetservice, welcher seinen Benutzern ermöglich verschlüsselte Nachrichten über einzigartige (HTTPS) Links über das Internet zu verschicken. Jede Nachricht wird nach ihrem ersten Öffnen mittels des Links restlos aus unserer Datenbank gelöscht und kann somit nicht wiederhergestellt werden.</p>
	...
	<p>Nachricht.co nutzt Google Analytics (mit anonymisierten IP-Adressen) und den Google Website-Übersetzer. Wir verweisen daher auch auf deren Datenschutzerklärungen.</p>
