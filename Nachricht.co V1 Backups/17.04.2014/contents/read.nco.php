...
if (empty($encrypted))
	...
	$htmln = str_replace(':)', '<img src="/img/smileys/smile.gif">', $htmln);
	$htmln = str_replace(':-)', '<img src="/img/smileys/smile.gif">', $htmln);
	$htmln = str_replace(':(', '<img src="/img/smileys/sad.gif">', $htmln);
	$htmln = str_replace(':-(', '<img src="/img/smileys/sad.gif">', $htmln);
	$htmln = str_replace(';)', '<img src="/img/smileys/wink.gif">', $htmln);
	$htmln = str_replace(';-)', '<img src="/img/smileys/wink.gif">', $htmln);
	$htmln = str_replace(':D', '<img src="/img/smileys/grin.gif">', $htmln);
	$htmln = str_replace(':-D', '<img src="/img/smileys/grin.gif">', $htmln);
	$htmln = str_replace(':o', '<img src="/img/smileys/surprised.gif">', $htmln);
	$htmln = str_replace(':-o', '<img src="/img/smileys/surprised.gif">', $htmln);
	$htmln = str_replace(':O', '<img src="/img/smileys/surprised.gif">', $htmln);
	$htmln = str_replace(':-O', '<img src="/img/smileys/surprised.gif">', $htmln);
	$htmln = str_replace(':S', '<img src="/img/smileys/confused.gif">', $htmln);
	$htmln = str_replace(':-S', '<img src="/img/smileys/confused.gif">', $htmln);
	$htmln = str_replace(':p', '<img src="/img/smileys/razz.gif">', $htmln);
	$htmln = str_replace(':P', '<img src="/img/smileys/razz.gif">', $htmln);
	$htmln = str_replace(':-p', '<img src="/img/smileys/razz.gif">', $htmln);
	$htmln = str_replace(':-P', '<img src="/img/smileys/razz.gif">', $htmln);
	$htmln = str_replace('8)', '<img src="/img/smileys/cool.gif">', $htmln);
	$htmln = str_replace('8-)', '<img src="/img/smileys/cool.gif">', $htmln);
	echo $htmln;
