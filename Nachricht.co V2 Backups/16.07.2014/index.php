	...
	?>
		...
		<!-- CTA -->
			<section id="cta">
				...
				<header>
					<h2>Wir brauchen <strong>deine Hilfe</strong>!</h2>
					<p>Du möchtest uns unterstützen und uns helfen dieses Projekt weiter zuführen?<br />
					</header>
				<footer>
					<ul class="buttons">
						<li><a href="<? echo $spenden_url; ?>" class="button special"><? echo $spenden2; ?></a></li>
						<li><a href="/kontakt/" class="button">Schreib uns!</a></li>
					</ul>
				</footer>
