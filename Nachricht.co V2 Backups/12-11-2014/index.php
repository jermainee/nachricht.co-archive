...
<html lang="de">
	<head>
		...
		<link rel="alternate" hreflang="de" href="<? echo $protocol.$_SERVER["HTTP_HOST"]; ?>" />
		<link rel="canonical" href="<? echo $canonical; ?>"/>
		<link rel="shortcut icon" href="/favicon.ico" type="image/x-icon">
		<link rel="icon" href="/favicon.ico" type="image/x-icon">
		<link href="paypal-widget/widget.css" rel="stylesheet" />
	...
	?>
		...
		<!-- CTA -->
			<section id="cta">
				...
				<header>
					...
					<p>Du möchtest dieses Projekt unterstützen und mir helfen dieses Projekt weiterzuführen?<br />
					</header>
				<footer>
					<ul class="buttons">
		...
		<!-- Footer -->
			<footer id="footer">
				...
				<a href="/impressum/" style="font-size:14px;">Impressum & Disclaimer</a>
