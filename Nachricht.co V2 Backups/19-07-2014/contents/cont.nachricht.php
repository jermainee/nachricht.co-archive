...
?>
										<footer>
												<ul class="buttons">
													<li><a href="/home/" class="button small">Neue Nachricht</a></li>
												</ul>
											</footer>
										</section>
										<section style="margin-top: 30px; max-width: 680px;">
								...
								<!-- Sidebar -->
									<div class="sidebar" style="max-width: 310px;">
										...
										<section>
											...
											<footer>
												<ul class="buttons">
													<li><a href="/kontakt/" class="button small">Jetzt nachfragen!</a></li>
												</ul>
											</footer>
										</section>
									</div>
