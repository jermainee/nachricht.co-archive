		...
		<!-- Main -->
			<article id="main">
				...
				<header class="special container">
					...
					<h2>Schreib uns!</h2>
					<p>Du hast Fragen, Ideen oder einen Bug gefunden?<br />Schreib mir, ich sind für dich da!</p>
				</header>
				...
				<!-- One -->
					<section class="wrapper style4 special container small">
						...
						<!-- Content -->
							<div class="content">
							<p><strong>Das Kontaktformular ist derzeit außer Betrieb!</strong><br />Bitte schreib mir eine E-Mail an info@nachricht.co</p>
							<?
