				...
				$window.on('load', function() {
					...
					// Apply scrollgress to banner.
						$banner.scrollwatch({
							...
							range:		1,
							anchor:		'top',
							on:			function() { $header.addClass('alt reveal'); $logo.removeClass('content'); $logo.addClass('intro'); },
							off:		function() { $header.removeClass('alt'); $logo.removeClass('intro'); $logo.addClass('content'); }
						});
