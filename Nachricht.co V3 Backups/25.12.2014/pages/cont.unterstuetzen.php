	...
	<div class="container">
		<section class="content">
			<section class="bigbox side left round">
				...
				<ol>												
					<li><a href="/unterstuetzen/#paypal">Einfach mit PayPal</a></li>
					<li><a href="/unterstuetzen/#bitcoin">Anonym mit Bitcoins</a></li>
					<li><a href="/unterstuetzen/#adify">Werbung auf deiner Webseite</a></li>
				</ol>
