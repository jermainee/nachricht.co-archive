...
?>
	...
	<div class="container">
		<section class="content">
			<section class="bigbox round shadow">
				<section class="tw1 right round">
					<a class="twitter-timeline" href="https://twitter.com/nachrichtco" data-widget-id="565489290696998912">Tweets von @nachrichtco </a>
					<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
				</section>
				
				<h2>Unterstützen</h2>
				<p>Nachricht.co funktioniert nur dank seiner Benutzer und wird durch die Hilfe seiner Benutzer finanziert, weshalb du nirgends auf dieser Seite nervige Werbebanner oder ähnliches finden wirst, solange genug gespendet wird. Es fallen natürlich auch Kosten für mich als Betreiber an, wie zum Beispiel für den Server, die Weiterentwicklung und für Werbung. Um diese Kosten decken zu können und das Projekt am Leben zu erhalten brauche ich deine Hilfe:</p>
				...
				<article id="bitcoin">
					...
					Bitcoin: <a href="bitcoin:15f1j2HirT4xWmfHMbvux5zP7zaw4XsZiL">15f1j2HirT4xWmfHMbvux5zP7zaw4XsZiL</a></p>
				</article>
				...
				<article id="adify">
					...
					<code>&lt;a href="http://nachricht.co/" title="Nachricht.co - Verschicke sich selbstzerstörende Nachrichten per Link"&gt;Nachricht.co - Verschicke sich selbstzerstörende Nachrichten per Link!&lt;/a&gt;</code>
					...
					<code>&lt;a href="http://nachricht.co/" title="Nachricht.co - Verschicke sich selbstzerstörende Nachrichten per Link"&gt;&lt;img src="http://nachricht.co/b/01ani.gif" alt="Nachricht.co - Verschicke sich selbstzerstörende Nachrichten per Link" border="0" width="468" height="60"&gt;&lt;/a&gt;</code>
					</p>
				</article>
				<section class="tw2 round">
					<a class="twitter-timeline" href="https://twitter.com/nachrichtco" data-widget-id="565489290696998912">Tweets von @nachrichtco </a>
					<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
				</section>
			</section>
	...
	<? include('pages/misc.bekannt-aus.php'); ?>