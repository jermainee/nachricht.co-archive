...
<html lang="de">
	<head>
		...
		<script type="text/javascript">
    		window.cookieconsent_options = {"message":"Durch Verwendung dieser Webseite erklärst du dich damit einverstanden, dass Nachricht.co Cookies verwendet, um die Funktionalität und Leistung der Seite zu verbessern und dir Werbung für andere Webseiten anzuzeigen.","dismiss":"OK","learnMore":"Mehr erfahren","link":null,"theme":"dark-floating"};
		</script>
	...
	<div class="notification"><? echo $notify; ?> <a href="https://nachricht.co/unterstuetzen/">Jetzt unterstützen!</a></div>
	...
	<div class="container">
		<section class="content">
			<section class="bigbox round shadow">
				...
				<p class="last">Nun klickt dein Gesprächspartner auf den Link und kann die Nachricht lesen. Die Nachricht wird automatisch beim Öffnen gelöscht.</p>
			</section>
		</section>
	</div>
	</section>
