	...
	<div class="container">
		<section class="content">
			<section class="bigbox sidebox round shadow">
				...
				<p>Zum Schutz persönlicher Daten bei der Datenübertragung zwischen unserem Server und deinem Gerät benutzen wir TLS (Transport Layer Security), den Nachfolger von SSL (Secure Sockets Layer). Dieses Protokoll stellt sicher, dass kein unbefugter Dritter die Kommunikation abhören oder manipulieren kann.</p>
