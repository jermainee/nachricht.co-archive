...
if(isset($_POST['erstellen']))
	...
	{	
        ...
        //Debug nco_debug($nachricht, $id, $timestamp);
?>
		...
		<div class="container shadow">
			<div class="output-link round">
                ...
                <p id="ncolink" style="display:none;"><?php echo $link; ?></p>
                <button onclick="copyToClipboard('#ncolink')" class="button round">Link kopieren</button>
			</div>
		</div>
		<?php 
        if($inform == false)
